...
const handlePromise = (promise)=>{
    return promise.then((message)=>showNotification("success", message)).catch((message)=>showNotification("warning", message));
};
...
handlePromise(firstPromise).then(()=>handlePromise(secondPromise)).then(()=>handlePromise(thirdPromise));
